    ...
    <section className="parallax">
      <div className='parallax__content absolute top-[10%] sm:top-[16%] lg:top-[24%] w-full mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-96 xl:pr-72 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row items-start z-10'>
        ...
        <div className="flex-1 flex justify-start lg:justify-end mt-4 sm:mt-14 ml-8 xs:ml-[-4vh] sm:ml-[-17vh] md:ml-[-26vh] lg:mt-10 2xl:mt-0">
          ...
          B.Tech student in Computer Science and Engineering with a strong foundation in programming, web development, and data structures. Experienced in developing responsive websites using modern frameworks like React and Tailwind CSS. Passionate about learning and constantly seeking opportunities to grow as a developer.
          </div>
        </div>
      </div>
